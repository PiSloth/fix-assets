<div>
    <div>
                    ...
                    @forelse ($departments as $department)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <x-danger-button
                                    x-on:click.prevent="$dispatch('open-modal', 'confirm-department-delete')"
                                    wire:click='setDelete({{ $department->id }})'>
        ...
        <x-modal name="confirm-department-delete" :show="$errors->isNotEmpty()" focusable>
            <form wire:submit="delete" class="p-6">

                <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                    {{ __('Are you sure you want to delete department?') }}
                </h2>

                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {{ __('Once your department is deleted, all of its porducts and data will be permanently deleted.') }}
                </p>
